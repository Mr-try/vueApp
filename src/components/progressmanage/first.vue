    ...
    <div>
        <el-row :gutter="24" style="float: left;margin-top: 30px;margin-bottom:10px;z-index: 9">
            <el-form :inline="true" :model="formInline" class="demo-form-inline">
                ...
                <el-form-item class="select-date">
                    <el-date-picker v-model="formInline.startdate" type="date" placeholder="查询时间"
                ...
                <el-form-item class="select-input">
                    <el-select v-model="formInline.proDepartment" placeholder="全部乡镇">
                        <el-option v-for="item in options" :label="item.label" :value="item.value"></el-option>
                    </el-select>
                </el-form-item>
                <el-form-item class="select-input">
                    <el-select v-model="formInline.proBelong" placeholder="全部单位">
                        <el-option v-for="item in options" :label="item.label" :value="item.value"></el-option>
                    </el-select>
                </el-form-item>
                <el-form-item class="select-input">
                    <el-select v-model="formInline.proIndustry" placeholder="项目分类">
                        <el-option v-for="item in options" :label="item.label" :value="item.value"></el-option>
                    </el-select>
                </el-form-item>
                <el-form-item>
        ...
        <el-row :gutter="24" style="float:left;margin-top: -10px;z-index: 9">
            <el-radio-group v-model="radio1" @change="showtype">
                ...
                <el-radio class="radio" :label="2">已上报</el-radio>
                <el-radio class="radio" :label="3">未上报</el-radio>
            </el-radio-group>
        </el-row>
